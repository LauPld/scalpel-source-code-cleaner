...
// add_action('wp_enqueue_scripts', 'scalsoco_video_external_stylesheet');
*/

// Uncomment the following function to use inline styles for video element styles
function scalsoco_video_inline_styles() {
...
add_action('wp_enqueue_scripts', 'scalsoco_video_inline_styles');
